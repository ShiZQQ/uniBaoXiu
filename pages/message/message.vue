<template>
	<view class="message tn-safe-area-inset-bottom">
		...
		<view class="tn-margin-top-sm tn-padding-bottom-lg">
				...
				<view class="tn-padding-left-sm" style="width: 100%;">
					<view class="tn-flex tn-flex-row-between tn-flex-col-between">
						<view class="justify-content-item">
							<text class="tn-color-cat tn-text-lg tn-text-bold">管理员</text>
						</view>
			...
			<view class="tn-flex tn-flex-col-top tn-margin tn-cat-shadow tn-padding" v-for="(item,index) in 2"
				:key="index" @click="tn('./message_details/message_details')">
				<view class="">
				...
				<view class="tn-padding-left-sm" style="width: 100%;">
					<view class="tn-flex tn-flex-row-between tn-flex-col-between">
						<view class="justify-content-item">
							<text class="tn-color-cat tn-text-lg tn-text-bold">张三</text>
							<text class="tn-color-gray tn-padding-left-sm tn-padding-right-xs">维修人员</text>
						</view>
