...
export default class TUICallService implements ITUICallService {
  ...
  public async switchCamera() {
    try {
      await this._tuiCallEngine.switchCamera();
    } catch (error) {
      console.error(`${NAME.PREFIX}_switchCamera failed, error: ${JSON.stringify(error)}.`);
    }
  }
  @avoidRepeatedCall()
  public setSoundMode(type?: string): void {
    try {
      ...
      console.error(`${NAME.PREFIX}setSoundMode failed, error: ${JSON.stringify(error)}.`);
    }
  }
