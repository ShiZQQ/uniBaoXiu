...
const k = iA.getInstance(), n = rA.getInstance(), Oe = "3.1.4", Wa = "vue2.6", cA = class {
  constructor() {
  ...
  async init(A) {
    try {
      ...
      this._TUICore && (l = this._TUICore.SDKAppID, e = this._TUICore.tim), this._tim = e, console.log(`${s.PREFIX}init sdkAppId: ${l || o}, userId: ${t}`), this._tuiCallEngine = ra.createInstance({
        ...
        callkitVersion: Oe,
        chat: u || !1
      }), this._addListenTuiCallEngineEvent(), n.update(i.CALL, s.LOCAL_USER_INFO, { userId: t }), await this._tuiCallEngine.login({ userID: t, userSig: a, assetsPath: "" }), this._updateDeviceList();
    } catch (t) {
  ...
  async joinInGroupCall(A) {
    try {
      ...
      A.type === U.VIDEO && await this.openCamera(s.LOCAL_VIDEO), n.update(i.CALL, s.IS_CLICKABLE, !0), this._startTimer(), await this._tuiCallEngine.setVideoQuality(n.getData(i.CALL, s.VIDEO_RESOLUTION));
  ...
  async accept() {
    var A;
    try {
      n.update(i.CALL, s.CALL_STATUS, O.CONNECTED);
